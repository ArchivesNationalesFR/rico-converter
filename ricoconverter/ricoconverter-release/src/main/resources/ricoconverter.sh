...
read -p "Enter command to execute (convert_eac, convert_eac_raw, convert_ead, validate, test_eac, test_ead, version, help) [press Enter for '$command_default'] :" command
